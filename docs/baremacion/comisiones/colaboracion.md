...
| Acción | Descripción | Imagen |
| :--- | :--- | :---: |
| **Apertura** | Una vez verificada la versión de Office, abra el archivo de trabajo que desea compartir. | ![apertura](../../assets/images/image_colaboracion_4.png){ width="25%" } |
...
| Acción | Descripción | Imagen |
| :--- | :--- | :---: |
| **1. Opción "Compartir"** | Haga clic en la opción "Compartir" en la esquina superior derecha de la ventana. | ![opción compartir](../../assets/images/image_colaboracion_5.png){ width="25%" } |
| **2. Carga en la Nube** | Seleccione la cuenta institucional "OneDrive - ull.edu.es" y espere a que el archivo se cargue. | ![dominio ull](../../assets/images/image_colaboracion_13.png){ width="25%" } <br><br> ![espere a que cargue](../../assets/images/image_colaboracion_6.png){ width="25%" } |
| **3. Configuración de Vínculos** | <ul><li>Acceda a "Configuración de vínculos".</li><li>Seleccione la opción "Personas determinadas".</li><li>En "Otras configuraciones", active la casilla "Permitir la edición".</li><li>Pulse en "Aplicar".</li></ul> | ![permisos 1](../../assets/images/image_colaboracion_7.png){ width="25%" } <br><br> ![permisos 2](../../assets/images/image_colaboracion_8.png){ width="25%" } |
| **4. Envío** | Introduzca los correos electrónicos de las personas autorizadas para generar el envío del vínculo. | ![envío de credenciales](../../assets/images/image_colaboracion_9.png){ width="25%" } |
...
| Acción | Descripción | Imagen |
| :--- | :--- | :---: |
| **Notificación** | Los colaboradores recibirán un correo electrónico para abrir el archivo directamente. | ![correo recibido](../../assets/images/image_colaboracion_10.png){ width="25%" } |
| **Identidad** | El sistema solicitará un código de verificación para confirmar la identidad antes de permitir el acceso. | ![código verificación](../../assets/images/image_colaboracion_11.png){ width="25%" } |
| **Modo Colaborativo** | Una vez dentro, el propietario y los usuarios autorizados podrán trabajar de forma simultánea. El programa indicará quién se ha unido y quién tiene abierto el libro en ese momento. | ![trabajo colaborativo](../../assets/images/image_colaboracion_12.png){ width="25%" } |
| **Autoguardado** | Verifique que el interruptor de AutoGuardado (arriba a la izquierda) esté Activado. Esto garantiza que los cambios de todos los usuarios se fusionen al instante. | ![autoguardado](../../assets/images/image_colaboracion_autoguardado.png){ width="25%" } |
